...
function usage() {
    echo "Usage: $0 -i <input directory> -o <output directory> -D <database_directory> -d <name_kaiju_database> [-t <threads>] [-k <krona_dir>] [-c <class_dir>] [-x <taxa_names_dir>] [-m <merge_dir> ] [-k <kraken_input>]"
    echo ""
    echo "Options:"
