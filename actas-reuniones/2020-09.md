...
- [x] Ir escribiendo la documentación del pipeline.
...
- [x] Empezar a escribir documentación.
- [x] Asegurarse que los errores de nuestros scripts sean enviados al STDERR (>&2).
- Juan:
    - [x] Poner actas en GitHub.
    - [x] Arreglar script Trimmomatic.
...
- [x] Leer [este artículo](https://doi.org/10.1371/journal.pcbi.1005510).
- [x] Mañana a las 20:00 acordar un esquema de nomenclatura para los archivos.
- [x] Discutir cómo activar Conda desde un script.
...
pareja y los que no).
- [x] Leer [artículo de María](http://www.musalit.org/seeMore.php?id=19153).

# 2020-09-23

Estefa nos mostró la documentación que empezó a escribir.

Cristian nos propuso decidir los nombres de los ambientes, volver a correr todo 
el pipeline y nos contó que Kaiju puede unir su output con el de Kraken.

Decidimos que los ambientes de conda llevarán se agruparan de la siguiente manera:

- preprocessing: Trimmomatic and Bowtie2
- assembly: metaSPAdes, MEGAHIT and MetaQast
- picking16S: QIIME2 y BBduk
- binning: Kaiju and Kraken
- humman2
- metaphlan


Miramos los issues de GitHub.

Recordamos que los datos en bruto deben estar protegidos contra escritura con
`chmod -w archivo`.

Hablamos sobre la posibilidad de paralelizar algunas partes de nuestro pipeline.
Más info sobre esto [aquí](https://medium.com/@robert.i.sandor/getting-started-with-parallelization-in-bash-e114f4353691). ¿Será conveniente hacerlo?

## Por hacer

- [x] Darle una mirada a los objetivos del trabajo de Estefa este viernes.
...
- [x] Para el miércoles dejar listos los scripts de manera que se activen los 
ambientes de Conda.

# 2020-09-30 11:00 UTC-5

## Por hacer
- [ ] Buscar programas para el análisis del rendimiento de los scripts.
- [ ] Correr el pipeline.
- [ ] Que Estefa nos muestre avances de la introducción (07 Oct).
...
Bowtie2=bt2).
- [ ] Hablar sobre proveer un set de datos de prueba con el pipeline.
- [ ] Evaluación del ensamblaje con MetaQUAST.
- [ ] Revisar si se puede hacer algún tipo de híbrido con metaWRAP.
- [x] ¿Cerrar issue de Activar Conda desde los scripts?
- [x] Quitar requerimiento de ambiente de Conda en `bowtie2.sh`.
